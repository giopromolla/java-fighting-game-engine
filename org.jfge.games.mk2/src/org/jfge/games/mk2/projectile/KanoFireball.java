...
public final class KanoFireball implements Provider<Projectile> {
	/** The projectile. */
	 ...
	 */
	@Inject
	public KanoFireball(ProjectileParser projectileParser) throws ParserConfigurationException, SAXException, IOException {
	...
	public Projectile get() {
		if(projectile == null) {
			try {
				this.projectile = projectileParser.parseFromXmlFile("/org/jfge/games/mk2/projectile/kanofireball/kanofireball.xml");
