...
public class LiuKangFireball implements Provider<Projectile> {
	 ...
	 */
	@Inject
	public LiuKangFireball(ProjectileParser projectileParser) throws ParserConfigurationException, SAXException, IOException {
	...
	public Projectile get() {
		if(projectile == null) {
			try {
				this.projectile = projectileParser.parseFromXmlFile("/org/jfge/games/mk2/projectile/liukangfireball/liukangfireball.xml");
