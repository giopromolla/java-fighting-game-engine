 ...
 */
@Singleton
public final class MortalKombat2FighterCollisions implements Provider<CollisionHandler> {
	 ...
	 */
	@Inject
	public MortalKombat2FighterCollisions(CollisionHandlerParser collisionHandlerParser) {
	...
	public CollisionHandler get() {
		if(collisionHandler == null) {
			try {
				this.collisionHandler = collisionHandlerParser.parseFromXmlFile("/org/jfge/games/mk2/collision/MortalKombat2FighterCollisions.xml");
