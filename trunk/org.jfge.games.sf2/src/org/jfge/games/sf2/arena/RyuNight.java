...
public class RyuNight implements Provider<Arena> {
	...
	@Inject
	public RyuNight(@Named("arenaRenderer.streetFighter2") ArenaRenderer arenaRenderer, ArenaFactory arenaFactory) {
	...
	public Arena get() {
		if(this.arena == null) {
			try {
				this.arena = arenaFactory.createArena("/org/jfge/games/sf2/arena/images/ryuNight.png", arenaRenderer);
			} catch (IOException e) {
				e.printStackTrace();
			}
		}
